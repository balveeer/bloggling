...
import {createAccount, googleLogin} from "../appwrite/auth";
import { Link, useNavigate } from "react-router-dom";
import { Input,Logo,UserType } from "../components/index";
...
function Signup() {
  ...
  const create:any = async (data:UserType) => {
    setLoad(true);
    setError("");
    try {
  ...
  return (
    <div className="flex items-center justify-center m-3">
      ...
      <div className="mb-2 flex justify-center">
        ...
        <p className="mt-2 w-full text-center text-base text-black/60 dark:text-white">
        ...
        <button
              ...
              className="w-full rounded-lg p-1 mt-6 text-black bg-white hover:bg-white font-bold"
            >
    ...
    <div className="flex items-center justify-center w-full">
      <div className="h-[0.1rem] rounded bg-gray-500 dark:bg-gray-300 flex-grow"></div>
