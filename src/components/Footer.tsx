...
function Footer() {
  return (
    <section className="w-full overflow-hidden z-0 py-4 bg-violet-300/70 dark:bg-gray-900/70  border-t-2 dark:border-t-gray-700 border-t-purple-300">
      ...
      <div className="flex items-center justify-center">
        <div className="flex mt-4 justify-center gap-2">
          <a href="#" className=" grayscale hover:grayscale-0 p-2 rounded hover:shadow-lg  text-[#5865f2]">
            <svg
              className="w-6 h-6"
              aria-hidden="true"
          ...
          <a href="#" className=" p-2 rounded hover:shadow-lg grayscale hover:grayscale-0 text-[#1DA1F2]">
            <svg
              className="w-6 h-6"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
